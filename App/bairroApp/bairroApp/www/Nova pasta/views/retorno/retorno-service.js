"use strict";
angular.module('bairroApp.retornoService', ['bairroApp.usuarioAutenticacao'])
  .service('retornoService', retornoService);

/*
 * Prover servico de dados e operações
 */
function retornoService	($http, $location) {
    /*
