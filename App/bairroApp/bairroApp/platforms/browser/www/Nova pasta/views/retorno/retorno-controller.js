"use strict";
angular.module('bairroApp.retorno', ['bairroApp.usuarioAutenticacao',
                                 'bairroApp.retornoService',
                                 'autocomplete'])
  .controller('RegistroController', function($scope, $location, $filter, receiptService, userService, autocompleteService) {
