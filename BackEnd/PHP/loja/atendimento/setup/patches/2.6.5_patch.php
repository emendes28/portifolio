...
<?
	...
	if ( $action == "execute" )
	{
		...
		else
		{
			...
			$query = "ALTER TABLE chat_admin ADD console_refresh MEDIUMINT DEFAULT '10' NOT NULL AFTER op2op" ;
			database_mysql_query( $dbh, $query ) ;
			$query = "ALTER TABLE chatkbratings ADD catID INT( 10 ) UNSIGNED NOT NULL AFTER questID" ;
			database_mysql_query( $dbh, $query ) ;
			$query = "CREATE TABLE chatkbsearchterms (
