...
<html>
<head>
<title> v1.5.3 to v<?php echo $PATCH_VERSION ?> Patch </title>
...
<tr>
	<td valign="top"><span class="basetxt">
		...
		<?php if ( $success ): ?>
		<br>
		<big><b>Congratulations!  Your system DB has been patched from v1.5.3 to v<?php echo $PATCH_VERSION ?>!</b></big>
		<p>
