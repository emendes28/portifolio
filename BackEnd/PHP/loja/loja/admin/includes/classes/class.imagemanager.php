...
class ISC_ADMIN_IMAGEMANAGER {
	...
	/**
	* A reference of the template class to work with locally
	*
	* @var TEMPLATE
	*/
	...
	*/
	...
	private function View()
	{
		...
		$_SSSION['imageManagerSortBy'] = $sortby;
		...
		$this->template->SetTemplate('imgman.view');
	...
	*/
	private function GetNav($page, $total_items, $items_per_page)
	{
		...
		if($total_items > $items_per_page) {
			$nav = sprintf("(%s %d of %d) &nbsp;&nbsp;&nbsp;", GetLang('Page'), $page, $numPages);
