...
*
* @author Ray Ward <ray.ward@yagbu.net>
*/
abstract class ISC_ADMIN_EXPORTFILETYPE
{
	...
	*/
	public function Init(ISC_ADMIN_EXPORTMETHOD $exportmethod, $templateid, $where, $vendorid)
	{
		...
		// execute the query
		$this->query = $this->GetQuery($this->ConstructFieldList(), $where, $vendorid);
		$this->countquery = $this->GetListCountQuery($where, $vendorid);
	}
