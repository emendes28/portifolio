...
<?
	...
	if ( $action == "execute" )
	{
		...
		else
		{
			...
			$query = "ALTER TABLE chat_asp ADD knowledgebase TINYINT( 1 ) DEFAULT 0 NOT NULL AFTER admin_polling_type" ;
			database_mysql_query( $dbh, $query ) ;

			$query = "CREATE TABLE chatkbcats (
			...
			database_mysql_query( $dbh, $query ) ;
			$query = "CREATE TABLE chatkbquestions (
			...
			database_mysql_query( $dbh, $query ) ;
			$query = "CREATE TABLE chatkbratings (
				aspID int(10) unsigned NOT NULL default '0',
