...
<?
	...
	if ( $action == "execute" )
	{
		...
		else
		{
			...
			$query = "ALTER TABLE chatrefer ADD numfootprints SMALLINT UNSIGNED NOT NULL AFTER trackID" ;
			database_mysql_query( $dbh, $query ) ;
			$query = "ALTER TABLE chat_admin ADD utrigger TINYINT( 1 ) DEFAULT 1 NOT NULL AFTER last_active_time" ;
			database_mysql_query( $dbh, $query ) ;
