...
<?
	...
	if ( $action == "execute" )
	{
		...
		else
		{
			...
			$query = "ALTER TABLE chatfootprintsunique CHANGE surveyID deptID INT( 10 ) UNSIGNED DEFAULT '0' NOT NULL" ;
			database_mysql_query( $dbh, $query ) ;
			$query = "ALTER TABLE chatdepartments ADD email_trans TINYINT( 1 ) DEFAULT '1' NOT NULL AFTER initiate_chat" ;
			database_mysql_query( $dbh, $query ) ;
			$query = "ALTER TABLE chatfootprintsunique ADD INDEX ( deptID )" ;
			database_mysql_query( $dbh, $query ) ;
