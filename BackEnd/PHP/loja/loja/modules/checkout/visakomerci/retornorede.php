...
///////////////////////////////////////////////////
$query = sprintf("select * from [|PREFIX|]module_vars where modulename = 'checkout_visakomerci' and variablename = 'afi'");
...
echo "
<br>Caso seu navegador tenha bloqueado o popup do cupom, clique no link abaixo para visualizalo.<br />
