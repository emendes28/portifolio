...
class ISC_ENTITY_PRODUCT extends ISC_ENTITY_BASE
{
	...
	protected function addPrehook(&$savedata, $rawInput)
	{
		 ...
		 */
		if (isset($rawInput["prodprice"]) && isset($rawInput["prodretailprice"]) && isset($rawInput["prodsaleprice"]) && isset($rawInput["prodistaxable"])) {
			$savedata["prodcalculatedprice"] = CalcRealPrice($rawInput["prodprice"], $rawInput["prodretailprice"], $rawInput["prodsaleprice"], $rawInput["prodistaxable"]);
		}
