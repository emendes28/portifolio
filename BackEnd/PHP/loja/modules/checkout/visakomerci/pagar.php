...
$afi = corinthias("checkout_visakomerci","afi");
...
<input type="hidden" name="BANDEIRA" value="VISA" />
...
<input type="hidden" name="URLBACK" value="<?php echo $urlloja;?>/modules/checkout/visakomerci/retornorede.php" />
<input type="hidden" name="URLCIMA" value="<?php echo $urlloja;?>/modules/checkout/visakomerci/topo.jpg" />
