<?php
	...
	// Last Updated: 23rd Nov 2012 @ 2:07 AM

	$GLOBALS['ISC_CFG']["isSetup"] = true;
	$GLOBALS['ISC_CFG']["Language"] = 'br';
	$GLOBALS['ISC_CFG']["AllowPurchasing"] = '1';
	$GLOBALS['ISC_CFG']["serverStamp"] = 'CLIQUEgMxAjM98WY&ZlVxAHMHVHMMRVQGlWVo%&RJJUQBFUQBJne#JTQnFURMFUSSV0U';
	$GLOBALS['ISC_CFG']["HostingProvider"] = 'WWW.cliquemania.com';
	...
	$GLOBALS['ISC_CFG']["dbDatabase"] = 'storesuite';
	$GLOBALS['ISC_CFG']["tablePrefix"] = 'isc_';
	$GLOBALS['ISC_CFG']["StoreName"] = 'WebShop - Lojas virtuais';
	$GLOBALS['ISC_CFG']["StoreAddress"] = 'BR/BR';
	$GLOBALS['ISC_CFG']["LogoType"] = 'text';
	$GLOBALS['ISC_CFG']["StoreLogo"] = '';
	$GLOBALS['ISC_CFG']["ShopPath"] = 'http://localhost/loja';
	...
	$GLOBALS['ISC_CFG']["template"] = 'laranja';
	$GLOBALS['ISC_CFG']["SiteColor"] = 'blue';
	$GLOBALS['ISC_CFG']["CurrencyToken"] = ' R$ ';
	...
	$GLOBALS['ISC_CFG']["AdminEmail"] = 'evanmendes@live.com';
	$GLOBALS['ISC_CFG']["OrderEmail"] = 'evanmendes@live.com';
	...
	$GLOBALS['ISC_CFG']["TaxTypeSelected"] = 0;
	$GLOBALS['ISC_CFG']["PricesIncludeTax"] = 1;
	$GLOBALS['ISC_CFG']["DefaultTaxRateName"] = '';
	$GLOBALS['ISC_CFG']["DefaultTaxRate"] = 0;
	$GLOBALS['ISC_CFG']["DefaultTaxRateBasedOn"] = 'subtotal';

	// Shipping Settings
	$GLOBALS['ISC_CFG']["CompanyName"] = 'Webshop - Lojas virtuais';
	$GLOBALS['ISC_CFG']["CompanyAddress"] = 'www.cliquemania.com';
	$GLOBALS['ISC_CFG']["CompanyCity"] = 'SÃO VICENTE';
	$GLOBALS['ISC_CFG']["CompanyCountry"] = 'Brasil';
	$GLOBALS['ISC_CFG']["CompanyState"] = 'São Paulo';
	$GLOBALS['ISC_CFG']["CompanyZip"] = '11355450';

	// Checkout Settings
	$GLOBALS['ISC_CFG']["CheckoutMethods"] = 'checkout_digital';
	...
	$GLOBALS['ISC_CFG']["MailXMLAPIValid"] = 0;
	$GLOBALS['ISC_CFG']["MailXMLPath"] = '';
	$GLOBALS['ISC_CFG']["MailXMLToken"] = '';
	$GLOBALS['ISC_CFG']["MailUsername"] = '';
	$GLOBALS['ISC_CFG']["UseMailerForNewsletter"] = 0;
	$GLOBALS['ISC_CFG']["UseMailerForOrders"] = 0;
	$GLOBALS['ISC_CFG']["MailNewsletterList"] = 0;
	$GLOBALS['ISC_CFG']["MailNewsletterFormat"] = 'h';
	$GLOBALS['ISC_CFG']["MailNewsletterCustomField"] = 0;
	$GLOBALS['ISC_CFG']["MailOrderList"] = 0;
	$GLOBALS['ISC_CFG']["MailOrderFormat"] = 'h';
	...
	$GLOBALS['ISC_CFG']["MailAutomaticallyTickNewsletterBox"] = 0;
	...
	$GLOBALS['ISC_CFG']["MailProductUpdatesFormat"] = 'h';
	...
	$GLOBALS['ISC_CFG']['SystemLogTypes'] = 'general,payment,shipping,notification,ssnx,sql,php,accounting';
  ...
  2 => 'Store Credit',
	...
	$GLOBALS['ISC_CFG']['OrderStatusNotifications'] = '1,7,11,9,8,3,10,2,5,6,4';
  ...
  3 => 'paymentMethods',
	...
	$GLOBALS['ISC_CFG']['ProductImagesStorewideThumbnail_width'] = 120;
	$GLOBALS['ISC_CFG']['ProductImagesStorewideThumbnail_height'] = 120;
	$GLOBALS['ISC_CFG']['ProductImagesProductPageImage_width'] = 220;
	$GLOBALS['ISC_CFG']['ProductImagesProductPageImage_height'] = 220;
