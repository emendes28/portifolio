<?php
	...
	class ISC_ADMIN_DOWNLOADADDONS
	{
		...
		*/
		public function ListAddons()
		{
			...
			$GLOBALS["ISC_CLASS_TEMPLATE"]->SetTemplate("addons.manage");
		...
		*/
		public function PurchaseAddonForm()
		{
			if(isset($_GET['prodId']) && isset($_GET['prodPrice'])) {
				...
				$GLOBALS['BuyLink'] = "http://www.cliquemania.com/site/comprar.php?a=add&produto=" . $prodId;
				$GLOBALS['AddonPurchaseText'] = sprintf(GetLang("AddonPurchaseText"), (int)$prodPrice);
				$GLOBALS["ISC_CLASS_TEMPLATE"]->SetTemplate("addons.purchase");
				$GLOBALS["ISC_CLASS_TEMPLATE"]->ParseTemplate();
			}
		}
	}