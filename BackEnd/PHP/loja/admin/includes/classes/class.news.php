<?php
	...
	class ISC_ADMIN_NEWS
	{
		...
		public function ManageNews($MsgDesc = "", $MsgStatus = "")
		{
			...
			$GLOBALS["ISC_CLASS_TEMPLATE"]->SetTemplate("news.manage");
		...
		public function AddNewsStep1()
		{
			...
			$GLOBALS["ISC_CLASS_TEMPLATE"]->SetTemplate("news.form");
			$GLOBALS["ISC_CLASS_TEMPLATE"]->ParseTemplate();
		}
		...
		public function _CommitNews($NewsId=0)
		{
			...
			if(!$news->error) {
				...
				manageSuggestedWordDatabase("news", $NewsId, $_POST["newstitle"]);
			}
