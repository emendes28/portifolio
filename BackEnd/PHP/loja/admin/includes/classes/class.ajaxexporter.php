...
abstract class ISC_ADMIN_AJAXEXPORTER
{
	...
	public function AutoExport()
	{
		...
		DownloadFile($file, $exportResult, true, 'application/force-download');
	}
	...
	private function ExportIntro()
	{
		...
		$GLOBALS['ISC_CLASS_TEMPLATE']->SetTemplate("ajax.export");
	...
	private function DownloadExport()
	{
		...
		DownloadFile($file, $this->GetExportFileName(), true, 'application/force-download');
	}
